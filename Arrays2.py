...
sales_array = np.array([[150.68,207.99,107.88,58.99,60.59],[20.89,98.99,258.62,19.76,101.59],[70.66,190.10,134.54,200.14,15.59],[10.52,201.59,140.55,13.99,45.98]])

## Step 1: Print the total sales for the store.
print("-----------------------------------------------   STEP ONE   -----------------------------------------------")
print("Total sales for the store: $", round(np.sum(sales_array), 2))
print()

## Step 2: What was Superstore's smallest and largest sale? Print them.
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")
print("Smallest sale: $", np.min(sales_array))
print("Largest sale: $", np.max(sales_array))
print()
...
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
register_totals = np.sum(sales_array, axis=1)
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
fee_array = sales_array * 0.02
print("Fee array:")
print(np.round(fee_array, 2))
print("Total fees: $", round(np.sum(fee_array), 2))
print()
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
profit_array = sales_array - fee_array
print(np.round(profit_array, 2))
print()

## Step 7: Print the sales only for the second and forth cash register
print("-----------------------------------------------   STEP SEVEN  -----------------------------------------------")
print("Register 2 sales:", sales_array[1])
print("Register 4 sales:", sales_array[3])
print()
...
print("-----------------------------------------------   STEP EIGHT  -----------------------------------------------")
new_register = np.array([17.89,13.59,107.89,176.88,56.78])
sales_array = np.vstack([sales_array, new_register])
print(sales_array)
print()
